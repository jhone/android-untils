...
public abstract class BaseCase<T> extends TestCase {
	private static final String CONFIG_LOCATIONS = "classpath*:resources/applicationContext*.xml,"
			+ "classpath*:resources/applicationContext-managers.xml";
...
//		+ "META-INF/applicationContext-security.xml";
	...
	protected <t> T  createAction(Class<T> clazz, String namespace, String name,String methodName)
			throws Exception {
		...
		proxy = dispatcher.getContainer().getInstance(ActionProxyFactory.class)
				.createActionProxy(namespace, name ,methodName, null, true, false);
	...
	protected void setUp() throws Exception {
		...
		// to
		// scan packages for actions (thanks to Hardy Ferentschik - Comment
