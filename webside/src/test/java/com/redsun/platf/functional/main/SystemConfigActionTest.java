package com.redsun.platf.functional.main;
...
import com.redsun.platf.functional.BaseFunctionalTestCase;
import com.redsun.platf.functional.Gui;
import com.redsun.platf.functional.Gui.CompanyColumn;
 ...
 * @author calvin
 */
public class SystemConfigActionTest extends BaseFunctionalTestCase {
	...
	public void overviewPage() {
		driver.findElement(By.linkText(Gui.MENU_COMPANY_CONFIG)).click();
		WebElement table = driver.findElement(By.xpath("//table[@id='contentTable']"));
		assertEquals("no1", SeleniumUtils.getTable(table, 1, CompanyColumn.COMPANY_NO.ordinal()));
		assertEquals("company1", SeleniumUtils.getTable(table, 1, CompanyColumn.COMPANY_NAME.ordinal()));
