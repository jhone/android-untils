...
<div id="bd">
	<div id="yui-main">
	<div class="yui-b">
	<form id="mainForm" action="system-company.action" method="get">
		...
		<div id="content">
			<table id="contentTable">
				<tr>
					<th><a href="javascript:sort('companyNo','asc')">公司代码*</a></th>
					<th><a href="javascript:sort('companyName','asc')">名称</a></th>
						...
						<td>&nbsp;
							<security:authorize ifAnyGranted="ROLE_浏览用户">
								<security:authorize ifNotGranted="ROLE_修改用户">
									<a href="system-company!input.action?id=${id}">查看</a>&nbsp;
								</security:authorize>
							</security:authorize>

							<security:authorize ifAnyGranted="ROLE_修改用户">
								<a href="system-company!input.action?id=${id}">修改</a>&nbsp;
								<a href="system-company!delete.action?id=${id}">删除</a>
							</security:authorize>
						</td>
					</tr>
				</s:iterator>
		...
		<div>
           ...
           <a href="system-company!input.action">新增1</a>

			<security:authorize ifAnyGranted="ROLE_修改用户">
				<a href="system-company!input.action">新增</a>
			</security:authorize>
		</div>
	</form>
	</div>
