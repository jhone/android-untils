 ...
 */
package com.redsun.platf.dao.springside;
 ...
 * @author calvin
 */
public class HibernateDao<T, PK extends Serializable> extends SimpleHibernateDao<T, PK> implements IBaseDao<T, PK>{
	/**
	 * 用于Dao层子类的构造函数.
	...
	@Override
	public int count(String queryString, Object[] params,
	...
	public List<T> find(String queryString, Object[] params,
			Map<String, Object> namedParams, Integer firstResult,
			Integer maxResults) {
		// TODO Auto-generated method stub
		return null;
	}
